...
class FlowNodeTestFixtureGen(cfixture.ContrailFixture):
    ...
    """
    def __init__(self, conn_drv, flow_node_name=None, parent_fixt=None, auto_prop_val=False, virtual_network_refs = None, tag_refs = None, flow_node_ip_address=None, flow_node_load_balancer_ip=None, id_perms=None, perms2=None, annotations=None, display_name=None):
        '''
...
class DeviceFunctionalGroupTestFixtureGen(cfixture.ContrailFixture):
    ...
    """
    def __init__(self, conn_drv, device_functional_group_name=None, auto_prop_val=False, physical_role_refs = None, tag_refs = None, device_functional_group_os_version=None, routing_bridging_roles=None, id_perms=None, perms2=None, annotations=None, display_name=None):
        '''
    ...
    def setUp(self):
        ...
        self._obj = vnc_api.DeviceFunctionalGroup(self._name)
        try:
